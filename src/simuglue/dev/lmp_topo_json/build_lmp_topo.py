...
from simuglue.topology.export import ExportTypesTopo, types_topo_to_dict, write_types_topo_json
...
def build_parser(prog: str | None = None) -> argparse.ArgumentParser:
    ...
    p.add_argument("--types-fmt", default="lammps-data", help="Optional: specify the format of the types table (lammps-data, json).")
...
def main(argv=None, prog: str | None = None) -> int:
    ...
    if args.types_out:
     #   if args.types_fmt == 'lammps-data':
     #       ExportTypesTopo(str(Path(args.types_out)), topo, lmp_type_table)
     #   elif args.types_fmt == 'json':
            d = types_topo_to_dict(topo, masses_table=lmp_type_table)
            write_types_topo_json(str(Path(args.types_out)), d)
