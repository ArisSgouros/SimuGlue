...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Parse Quantum ESPRESSO output (*.out) to JSON.")
    ap.add_argument("input", nargs="+", help="Files or globs, e.g. 'scf.out' or 'runs/*/scf.out'")
