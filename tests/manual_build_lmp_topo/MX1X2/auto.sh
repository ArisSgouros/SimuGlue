...
python ../compare.py o.supercell_topo.dat ref.supercell_topo_mod.dat --compare-tags all --verbose
#python ../compare.py o.supercell_topo.dat ref.supercell_topo_mod.dat --verbose
